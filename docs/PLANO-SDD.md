...
**#25 — Remodelagem Contas & Cartões (método de pagamento)** 🔨 EM ANDAMENTO (2026-07-22 — SDD: `docs/session-25-remodelagem-contas-cartoes/SDD.md`) — **prioridade sobre #24/#22 (decisão do usuário: o rearranjo de domínio vem antes do resto)**
