...
public interface TransactionRepository extends JpaRepository<Transaction, UUID>, JpaSpecificationExecutor<Transaction> {
	...
	@Query("select new com.guaranin.api.transaction.CategorySpent(t.categoryId, sum(t.amount)) "
			+ "from Transaction t "
			+ "where t.userId = :userId and t.type = com.guaranin.api.transaction.TransactionType.EXPENSE "
